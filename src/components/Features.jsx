    ...
    <section className="w-full bg-sky-50 py-20 relative">
      <div className="max-w-[1300px] mx-auto px-6 -mt-32 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {data.map((item, i) => (
            <div key={i} className="relative group bg-white border border-gray-200 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 
              hover:-translate-y-3 cursor-pointer flex flex-col items-center justify-center text-center">
