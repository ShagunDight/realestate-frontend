        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            {faqs.length === 0 ? (
              ...
              faqs.map((faq, index) => (
                <div key={faq._id || index} className="bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-md transition-all">

                  {/* QUESTION */}
                  <button onClick={() => toggleFAQ(index)} className="w-full flex justify-between items-center text-left px-6 py-5">
