          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                <div
                  key={i}
                  className="bg-white border border-sky-100 rounded-2xl p-4 text-center shadow-sm hover:shadow-md transition"
                >
        ...
        <div className="max-w-6xl mx-auto mb-32">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div
                key={i}
                className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-lg transition hover:-translate-y-1"
              >
        ...
        <div className="max-w-6xl mx-auto mb-32">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={i}
                className="bg-white border border-gray-100 rounded-2xl p-6 text-center shadow-sm hover:shadow-xl transition"
              >
